...
class MCDRpnHead(nn.Module):
    ...
    def __init__(
        ...
        """
        NOTE: this interface is experimental. This module has a dropblock layer at the objectness logits calculator
    ...
    @staticmethod
    def _get_rpn_conv(in_channels, out_channels):
        return Conv2d(
            in_channels,
            out_channels,
            kernel_size=3,
